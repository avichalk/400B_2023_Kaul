...
if __name__ == '__main__':
    ...
    benchmark2 = CosmologicalTools(OmegaMD, OmegaRD, OmegaLD, h_planck )
    ...
    #print(benchmark2.LookBackTime(1e3))
    ...
    #TimeBenchMarkDesitter = [benchmark2.LookBackTime(i).value for i in zrange]
    ...
    ## FILL THIS IN
    #plt.semilogx(zrange+1 ,  TimeBenchMarkDesitter, color='red', linewidth=5, label='DeSitter')
    ...
    print(benchmark.ComovingDistance(0, 100))
    print(benchmark.ProperDistance(0, 100))
    ...
    print(benchmark.ComovingDistance(0, 1e3))



    # What is the size of the presently observable universe in the Einstein De Sitter cosmology? (pick a large z)

    print(benchmark.ProperDistance(0, 1e3))
    ...
    print(benchmark.ProperDistance(2, 1e3))



    # how much larger was the universe then vs now?
    print(benchmark.ProperDistance(2, 1e3)/benchmark.ProperDistance(0, 1e3))
